 ...
 */
export const APP_NAME: string = 'Farcaster FID App';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Displays the user\'s FID and account creation date.';
 ...
 */
export const APP_BUTTON_TEXT: string = 'Show FID';
